...
const words = ["ANIMAL", "BORDER", "COTTON", "DRAWER", "ELOPED", "FILING","GRAPES", "HORROR", "ISLAND", "JUNGLE", "KITTEN", "LISTEN", "MARKET", "NUMBER", "OBJECT", "PUZZLE", "QUAINT", "RESCUE", "SILENT", "TRAVEL", "UNIQUE", "VIOLET", "WINDOW", "YELLOW"];  
...
function showEndOptions() {
    const retry = confirm("Time's up! Retry level or move on to level 3? Press OK to move on.");
    if (retry) {
